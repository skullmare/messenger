    ...
    def get(self, request, uid, token, *args, **kwargs):
        ...
        if user is not None and default_token_generator.check_token(user, token):
            ...
            return render(
                ...
                context={"title": "Ваш аккаунт успешно активирован!", "desc": "Теперь вы можете войти и начать пользоваться нашим сервисом."},
                status=status.HTTP_200_OK
            )
        return render(
            request,
            template_name='account_activate_result.html',
            context={"title": "Ошибка 400", "desc": "Попробуйте зарегистрироваться еще раз или обратитесь в техническую поддержку!"},
